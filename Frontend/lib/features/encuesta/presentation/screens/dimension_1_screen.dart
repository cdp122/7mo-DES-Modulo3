...
class Dimension1Screen extends StatefulWidget {
  ...
  @override
  State<Dimension1Screen> createState() => _Dimension1ScreenState();
}

class _Dimension1ScreenState extends State<Dimension1Screen>
  ...
  final Color colorTema = const Color(0xFF3F51B5);
  ...
  void _regresar() {
    setState(() {
      if (_preguntaActualIndex > 0) {
        ...
        context.go('/portada', extra: widget.cedulaDocente);
      }
    });
  }
